...
router.post("/:version/auth/signin", UserController.signin);
router.delete("/:version/auth/signout", UserController.signout);
router.post("/:version/auth/signup", authorization, UserController.signup);
